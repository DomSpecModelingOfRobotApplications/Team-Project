/**
* \file testapidemonstration.cpp
* \brief Test how to call a module from the outside.
*
* An example on how to call the example "APIDemonstration" module from the outside.
*
*/
...
int main(int argc, char* argv[]) {
  ...
  try {
    /** Create a generic proxy to "APIDemontration" module.
    ...
    */
    ...
    = boost::shared_ptr<AL::ALProxy>(new AL::ALProxy("APIDemonstration", robotIP, port));
